...
> **开发者注**：这并不是 Bug，而是 `cbot` 拥有强烈的“自我净化”意识。我们决定保留这一特性，作为它拥有灵魂的证据。(这就是bug，但是开发者没改，开发者害怕改完后清理不干净了)
...
- [ ] 增加 `cbot build` 模块，一键编译并让 AI 分析报错信息。
- [ ] 完善 `dry-run` 模式。
...
---
**Maintained by Zhang Wenbo** *Last updated: 2026-04-04*
